...
class NodeTreeTest extends AnyFunSuite {
  ...
  test("Can create Actions using createAction") {
    ...
    action2.newTree shouldEqual VariableNode("Plus", List(SubExprNode(ExprChoiceNode()), SubExprNode(ExprChoiceNode())))
  }
  ...
  test("SelectExprAction behaves as expected") {
    ...
    createAction(
      "SelectExprAction",
      tree1.toString,
      tree1.children(1).children(0).treePathString,
      List("Num")
    ...
    createAction(
      "SelectExprAction",
      tree1.toString,
      tree1.children(1).children(1).children(0).treePathString,
      List("Num")
    ).newTree shouldEqual VariableNode(
      "Plus",
      List(
  ...
  test("EditLiteralAction behaves correctly") {
    ...
    createAction(
      "EditLiteralAction",
      tree1.toString,
      tree1.children(1).children(1).children(1).args(0).treePathString,
      List("3")
    ).newTree shouldEqual VariableNode(
      "Plus",
      List(
          ...
          VariableNode(
            ...
            List(
              ...
              SubExprNode(
                VariableNode(
                  "Plus",
                  List(SubExprNode(ExprChoiceNode()), SubExprNode(VariableNode("Num", List(LiteralNode("3")))))
                )
              )
            )
          )
    ...
    createAction(
      "EditLiteralAction",
      tree1.toString,
      tree1.children(1).children(0).args(0).treePathString,
      List("")
    ).newTree shouldEqual VariableNode(
      "Plus",
      List(
  ...
  test("DeleteAction behaves correctly") {
    ...
    createAction("DeleteAction", tree1.toString, tree1.treePathString, List()).newTree shouldEqual ExprChoiceNode()

    val tree2 = ConcreteNode(
      Plus(Num(4), Num(6)).toString,
      List(
        SubExprNode(VariableNode("Num", List(LiteralNode("4")))),
        SubExprNode(VariableNode("Num", List(LiteralNode("6"))))
      )
    )
    createAction("DeleteAction", tree2.toString, tree2.treePathString, List()).newTree shouldEqual ExprChoiceNode()

    val tree3 = VariableNode(
      "Plus",
      List(
        SubExprNode(VariableNode("Num", List(LiteralNode("4")))),
        SubExprNode(VariableNode("Num", List(LiteralNode("6"))))
    ...
    createAction(
      "DeleteAction",
      tree3.toString,
      tree3.children(1).treePathString,
      List()
    ).newTree shouldEqual VariableNode(
      "Plus",
      List(SubExprNode(VariableNode("Num", List(LiteralNode("4")))), SubExprNode(ExprChoiceNode()))
    )
  }
  ...
  test("PasteAction behaves correctly") {
    ...
    createAction(
      "PasteAction",
      tree1.toString,
      tree1.children(1).treePathString,
      List(pasteCache)
    ).newTree shouldEqual VariableNode(
      "Plus",
      List(
        SubExprNode(VariableNode("Num", List(LiteralNode("4")))),
        SubExprNode(VariableNode("Num", List(LiteralNode("50"))))
      )
    )
  }
