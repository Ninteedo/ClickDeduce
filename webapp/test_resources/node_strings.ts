...
export const NODE_STRING_PATH_TEST_EXAMPLE: string =
    `VariableNode("Plus", List(SubExprNode(VariableNode("Times", List(SubExprNode(VariableNode("Bool", List(LiteralNode(LiteralBool(true))))), SubExprNode(VariableNode("Num", List(LiteralNode(0))))))), SubExprNode(VariableNode("IfThenElse", List(SubExprNode(VariableNode("Bool", List(LiteralNode(LiteralBool(false))))), SubExprNode(ExprChoiceNode()), SubExprNode(ExprChoiceNode()))))))`
