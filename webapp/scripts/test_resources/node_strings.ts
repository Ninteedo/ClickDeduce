...
export const PLUS_LEFT_FILLED_NUM_RIGHT_EMPTY: string =
    `VariableNode("Plus", List(SubExprNode(VariableNode("Num", List(LiteralNode("56")))), SubExprNode(ExprChoiceNode())))`;
...
export const TIMES_LEFT_FILLED_NUM_RIGHT_EMPTY: string =
    `VariableNode("Times", List(SubExprNode(VariableNode("Num", List(LiteralNode("56")))), SubExprNode(ExprChoiceNode())))`;
